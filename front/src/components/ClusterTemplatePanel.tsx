      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="inline-flex rounded-md border border-[var(--border)] bg-[var(--surface-strong)] p-0.5">
          <button
            ...
            className={tab === "templates" ? "rounded px-2 py-1 text-xs tcb-selected-accent" : "rounded px-2 py-1 text-xs text-[var(--muted)]"}
          >
            模板
          </button>
          <button
            ...
            onClick={() => setTab("json")}
            className={tab === "json" ? "rounded px-2 py-1 text-xs tcb-selected-accent" : "rounded px-2 py-1 text-xs text-[var(--muted)]"}
          >
            JSON 配置
          </button>
        </div>
                ...
                <div className="flex gap-2">
                  ...
                  {previewTemplateId === template.id && preview ? (
                    <button
                      ...
                      disabled={!canManage}
                      className="rounded-md px-3 py-2 text-sm tcb-solid-accent disabled:opacity-60"
                    >
