...
export function CommandPalette({
  ...
  return (
    <AnimatePresence>
      {open ? (
        <motion.div
          className="fixed inset-0 z-50 bg-[var(--overlay-backdrop-45)] p-4 pt-[12vh]"
          onMouseDown={onClose}
          ...
          >
            <div className="flex items-center gap-2 border-b border-[var(--border)] px-3 py-2">
              <div
                ...
                className="flex min-w-0 flex-1 items-center gap-2 rounded-lg border border-transparent px-2 focus-within:border-[var(--focus-ring)] focus-within:outline focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-[var(--focus-ring)]"
              >
