...
def register(app: web.Application, server) -> None:
    ...
    app.router.add_get("/api/admin/inline-completion/config", server.admin_inline_completion_config_get)
    app.router.add_patch("/api/admin/inline-completion/config", server.admin_inline_completion_config_patch)
    ...
    app.router.add_post("/api/admin/language-servers/{provider_id}/install", server.admin_language_server_install)
    app.router.add_post("/api/admin/language-servers/{provider_id}/update", server.admin_language_server_update)
    app.router.add_post("/api/admin/language-servers/redetect", server.admin_language_servers_redetect)
